...
class NotaDAO implements iNotaDAO {
	...
	public function save(NotaModel $nota){
            ...
            try{
                ...
                $parametros = array($nota->getMatriculaDisplina()->getId(),
                ...
                if($rs->rowCount() > 0){
                    ...
                    $md->setId($nota->getMatriculaDisplina()->getId());
